...
export class RecipeService {
  ...
  private fakeInit() {
    this.recipes.push(new RecipeModel( 0, 'nazev receptu', 'popis receptu', null,  false, {id: 1, email: 'test@test.cz'}, new Date(), null));
    this.recipes.push(new RecipeModel( 1, 'nazev receptu 1', 'popis receptu 1',null,   false, {id: 0, email: 'test@test.cz'}, new Date(), null));
    this.recipes.push(new RecipeModel( 2, 'nazev receptu 2', 'popis receptu 2',null,   false, {id: 1, email: 'test@test.cz'}, new Date(), null));
    this.recipes.push(new RecipeModel( 3, 'nazev receptu 3',  'popis receptu 3',  null, false, {id: 0, email: 'test@test.cz'}, new Date(), null));
  }
